...
#include "fx_impact.h"
	...
	#include "discharge/te_shotgun_shot.h"
...
#ifdef CLIENT_DLL
	C_DC_Player *pPlayer = ToDCPlayer( ClientEntityList().GetBaseEntity( iPlayerIndex ) );
#else
	CDC_Player *pPlayer = ToDCPlayer( UTIL_PlayerByIndex( iPlayerIndex) );
#endif
