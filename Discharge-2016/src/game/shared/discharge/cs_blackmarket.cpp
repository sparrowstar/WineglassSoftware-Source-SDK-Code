...
#include <KeyValues.h>
#include "discharge/cs_gamestats.h"
...
void TrackAutoBuyPurchases( const char *pWeaponName, CHL2_Player *pBuyer )
{
	return;
}

void BlackMarketAddWeapon( const char *pWeaponName, CHL2_Player *pBuyer )
{
